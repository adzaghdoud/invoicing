...
<body>
    ...
    <div class="container mt-7">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-dark table-flush" id="tablepaiement">
                ...
                <tbody>
                  <c:forEach var="liste" items="${ list_pending_paiements }">
                  <tr> 
                  <td> ${liste.nomfacture}</td>
                  <td> ${liste.client}</td>
                  <td> ${liste.article}</td>
                  <td> ${liste.date}</td>
                  <td> ${liste.totalttc}</td>
                
                   <td>
                      <span class="badge badge-dot mr-4">
                        <i class="bg-warning"></i> <span style="color:#FFA500">Pending</span>
                      </span>
                    </td>
                    <td><button type="button" class="btn btn-success" onclick="relance_paiement()" ><span class="spinner-border spinner-border-sm"  id="spinnerbutton" style="display:none;"></span>Relance Paiement</button></td>
                  </tr>
                  </c:forEach>
                </tbody>
              </table>
