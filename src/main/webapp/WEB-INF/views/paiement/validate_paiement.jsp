        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Liste des paiements à valider </h3> <br/>
                ...
                <tbody>
                  ...
                  <td> ${liste.totalttc}</td>
                   ...
                   <td>
                    ...
                    <td><button type="button" class="btn btn-success" onclick="validate_paiement()">validate</button></td>
                  </tr>
                  </c:forEach>
                </tbody>
              </table>
